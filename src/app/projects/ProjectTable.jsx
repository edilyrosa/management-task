...
//       {/* Tabla de proyectos con responsividad */}
...
//               <tr key={project.id} className="border-y border-gray-200 hover:bg-gray-50">
//                 <td className="px-6 py-4">{project.name}</td>
//                 <td className="px-6 py-4">{clientsMap[project.client_id] || 'Unknown'} - {project.client_id}</td>
